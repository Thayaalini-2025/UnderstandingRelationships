    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-yellow-50 p-4 md:p-8 flex items-center justify-center">
        ...
        <div className="max-w-4xl w-full text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">{t.practiceGoodChoices}</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border-4 border-green-200">
              ...
              <h3 className="text-2xl font-bold text-green-600 mb-2 text-center">{t.goodChoice}</h3>
              <p className="text-gray-600 text-center">{t.standingUpRespectfully}</p>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border-4 border-red-200">
              ...
              <h3 className="text-2xl font-bold text-red-600 mb-2 text-center">{t.notGoodChoice}</h3>
              <p className="text-gray-600 text-center">{t.hurtingOrIgnoring}</p>
